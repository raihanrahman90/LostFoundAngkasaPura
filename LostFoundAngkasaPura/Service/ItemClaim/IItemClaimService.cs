...
namespace LostFoundAngkasaPura.Service.ItemClaim
{
    public interface IItemClaimService
    {
        ...
        Task<Pagination<ItemClaimResponseDTO>> GetListItemClaimByItemFoundId(int page, int size, string itemFoundId, string? status);
        ...
        Task<string> DownloadAsPdf(string itemClaimId);
    }
}
